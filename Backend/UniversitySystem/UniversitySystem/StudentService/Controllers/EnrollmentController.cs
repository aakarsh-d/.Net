...
public class EnrollmentController : ControllerBase
{
    ...
    /// <summary>
    /// Starts the enrollment saga. Validates student, saves to DB, publishes StudentCreated event.
    /// </summary>
    [HttpPost]
    public async Task<IActionResult> Enroll([FromBody] EnrollmentRequest request)
    {
        ...
        _logger.LogInformation("Enrollment request received. EnrollmentId={EnrollmentId}", enrollmentId);
        ...
        // Step 2: Create student record (local transaction)
        ...
        _logger.LogInformation("Student {StudentId} saved. Publishing StudentCreated.", student.Id);

        // Step 3: Publish event to trigger Course Service (saga step 2)
