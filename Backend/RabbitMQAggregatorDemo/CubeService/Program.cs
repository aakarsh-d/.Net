...
channel.QueueDeclare("cube_queue", false, false, false, null);
channel.QueueBind("cube_queue", "calc_exchange", "");
...
consumer.Received += (model, ea) =>
{
    ...
    int result = msg.Value * msg.Value * msg.Value;
    ...
    Console.WriteLine($"Cube: {msg.Value}^3 = {result}");
};
